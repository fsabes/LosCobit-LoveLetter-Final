...
public class InterfazElejirNameUser extends JDialog {
	...
	public InterfazElejirNameUser(JFrame parent, boolean modal) {
		super(parent, modal);
		setUndecorated(true);
		pack();
	...
	private class DrawPanel extends JPanel {
		...
		protected void paintComponent(Graphics g) {
			...
			FontPersonalizado.dibujarTexto(g2, "Elija nombre de usuario", 130, 160);
